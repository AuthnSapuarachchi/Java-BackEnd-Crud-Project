        ...
        <div class="card shadow-sm p-4" style="max-width: 430px; width: 100%;">
            ...
            <form action="insertBooking" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="conNumber" name="conNumber" class="form-control" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="specRequirment" name="specRequirment" class="form-control" placeholder="Type here..." rows="3"></textarea>
                </div>
